...
def generate_frames(path_x = '',conf_= 0.25):
    ...
    #The function imencode compresses the image and stores it inthe memory buffer that is resized to fit the result.
...
def video():
    ...
    'static/files/vid.mp4',conf_=0.75),mimetype='multipart/x-mixed-replace;boundary=frame')
